...
class FavoritesPage 
{
  ...
  function __construct($viewtype=null)
  {
    ...
    $this->_pageDetails['title'] = "My Favorite Blogs";
    $this->_pageDetails['description'] = "My Favorite Blogs";
  ...
  function render(){
    ...
    View::makeFavoritesBody($this->_postsData);
  ...
  function getInitialData(){
      ...
      $this->_postsData = Posts::get_favorite_bloggers_posts(LbUser::getFacebookID(), 0, $initial_posts_to_retreive);
  }
}
?>