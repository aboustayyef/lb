...
class Posts
{
    ...
    public static function get_top_posts($hours, $posts_to_show = 5, $channel = NULL){
        ...
        if ($channel){
            $query = 'SELECT posts.post_image, posts.post_timestamp, posts.post_image_width, posts.post_image_height, posts.post_url, posts.post_title, blogs.blog_name, columnists.col_name, posts.blog_id 
